...
function generateCatalogMemberPages(schemaPath, outputPath) {
    ...
    typeFiles.forEach(function(typeFile) {
        ...
        var content = '!!! note\r\r' +
                      ...
                      '    trouble, check the [source code for this type](https://github.com/TerriaJS/rer3d-terriajs/blob/master/lib/Models/' + path.basename(propertiesFile, '.json') + '.js) or post a message to the [forum](https://groups.google.com/forum/#!forum/terriajs).\r\r';
