  ...
  return {
    remoteDataType: [
            ...
            // So we do not need to explicitly include esri-mapServer-group or esri-featureServer-group here.
            {
                ...
                name: 'Esri ArcGIS MapServer (layer singolo)'
            },
            {
                value: 'esri-featureServer',
                name: 'Esri ArcGIS FeatureServer (layer singolo)'
            },
            {
                value: 'rer-featureServer',
                name: 'RER FeatureServer (layer singolo)'
            },
            {
            ...
            {
                value: 'other',
                name: 'Altro (prova la conversione)'
            },
        ],
    localDataType: [
          {
