...
CesiumDragPoints.prototype.setUp = function () {
  ...
  if (
    ...
    !defined(this._terria.cesium.scene.camera)
  ) {
  ...
  this._mouseHandler.setInputAction(function (move) {
    ...
    // Use ray to find a more precise position
    /*var cartesian = that._camera.pickEllipsoid(
      move.endPosition,
      that._scene.globe.ellipsoid
    );*/
    const pickRay = that._camera.getPickRay(move.endPosition);
