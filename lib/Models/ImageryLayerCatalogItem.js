                ...
                if (defined(layer) && globeOrMap.isImageryLayerShown({layer})) {
                    if (catalogItem === catalogItem.terria.baseMap ||
                        ...
                        globeOrMap.terria.error.raiseEvent(new TerriaError({
                            sender: catalogItem,
                            title: 'Error accessing alla mappa base',
                            message:
                                'Un errore è stato riscontrato durante il tentativo di scaricare le immagini della mappa base ' + catalogItem.terria.baseMap.name + '.' + 
                                'Questo può indicare una problema della connessione internet oppure che la mappa base è temporaneamente non raggiungibile oppure che la mappa base non è valida.' +
                                'Selezionare una diversa mappa base. Seguono altri dettagli tecnici:<br/><br/>' +
                        ...
                        globeOrMap.terria.error.raiseEvent(new TerriaError({
                            sender: catalogItem,
                            title: 'Errore di accesso ad un layer del catalogo',
                            message:
                            'Un errore è stato riscontrato durante il tentativo di scaricare le immagini di ' + catalogItem.terria.baseMap.name + '.' + 
                            'Questo può indicare una problema della connessione internet oppure che il layer è temporaneamente non raggiungibile oppure che il layer non è valido.' +
                            'Seguono altri dettagli tecnici:<br/><br/>' +
                                '<pre>' + formatError(e) + '</pre>'
                        }));
