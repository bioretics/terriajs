...
function loadOgrData(ogrItem, file, url) {
    ...
    console.log('Attempting to convert file via the Terria-Server ogr2ogr web service');
...
function errorLoading(ogrItem, msg) {
    ...
    throw new TerriaError({
        sender: ogrItem,
        title: 'Errore di conversione in GeoJson',
        message: '\
Errore nel tentativo di convertire il file al formato GeoJson.  ' + msg + '  Per assistenza o informazioni potete contattarci scrivendo a \
