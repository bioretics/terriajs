...
OgrCatalogItem.prototype.canUseAsPath = function() {
...
OgrCatalogItem.prototype.useAsPath = function() {
  let coordinates;
  ...
  switch(this.pathType) {
    case PathTypes.featureCollectionMultiLineString:
      coordinates = featuresData.features[0].geometry.coordinates[0];
      break;
    case PathTypes.featureCollectionLineString:
      coordinates = featuresData.features[0].geometry.coordinates;
      break;
    case PathTypes.multiLineString:
      coordinates = featuresData.coordinates[0];
      break;
    case PathTypes.lineString:
      coordinates = featuresData.coordinates;
      break;
  }
