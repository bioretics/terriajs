...
function errorLoading(ogrItem, msg) {
    var terria = ogrItem.terria;
    if (!defined(msg)) {
        msg = "This may indicate that the file is invalid or that it is not supported by the " +
        terria.appName +
        " conversion service.";
    }
    throw new TerriaError({
        ...
        message: 
        "\
        Errore nel tentativo di convertire il file al formato GeoJson.  " + 
        msg +
        '  Per assistenza o informazioni potete contattarci scrivendo a \
        at <a href="mailto:' +
        terria.supportEmail +
        '">' +
        terria.supportEmail +
