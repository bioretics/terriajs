...
var Terria = function(options) {
  ...
  /**
   * Gets or sets whether "pickedFeatures" is setted from screen position.
   * @type {Boolean}
   */
  this.isFeaturePicked = undefined;
   ...
   * @type {Array}
   */
  this.sampledElevationPoints = undefined;

  /**
   * Detailed elevation path data
   * @type {Object}
   */
  this.detailedElevationPath = {
   ...
   * @type {Array}
   */
  //this.featureInfoCoordinate = undefined;
