...
function loadFromCapabilities(wmsItem) {
    ...
    if (defined(crs)) {
        if (crsIsMatch(crs, 'EPSG:3857')) {
            ...
            // No known supported CRS listed. Rise exception.
            var msg = "Nssuno dei CRS (sistemi di coordinate) disponibili\nper il layer WMS '" + wmsItem.name + "' è utilizzabile.\nCRS del layer: " + crs + "\n\nRIMUOVERE IL LAYER PER PROSEGUIRE!";
            throw msg;
        }
    }
