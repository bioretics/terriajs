...
var RerFeatureServerCatalogItem = require("./RerFeatureServerCatalogItem");
...
var registerCatalogMembers = function() {
  ...
  createCatalogMemberFromType.register(
    "rer-featureServer",
    RerFeatureServerCatalogItem
  );
  createCatalogMemberFromType.register("geojson", GeoJsonCatalogItem);
  createCatalogMemberFromType.register("rer-geojson", RerGeoJsonCatalogItem);
