        ...
        return (
            <div className={Styles.tabPanels}>
                <If condition={this.props.activeTab === 'local'}>
                    <div className={Styles.tabHeading}>Aggiungi file locale</div>
                    <section className={Styles.tabPanel}>
                        <label className={Styles.label}>
                            <strong>Step 1:</strong> Seleziona formato (opzionale)
                        </label>
                        <Dropdown
                        ...
                        />
                        <label className={Styles.label}>
                            <strong>Step 2:</strong> Seleziona file
                        </label>
                        <FileInput
                ...
                <If condition={this.props.activeTab === 'web'}>
                    <div className={Styles.tabHeading}>Aggiungi dati dal web</div>
                    <section className={Styles.tabPanel}>
                        <label className={Styles.label}>
                            <strong>Step 1:</strong> Select formato (opzionale)
                        </label>
                        <Dropdown
                        ...
                        />
                        <label className={Styles.label}>
                            <strong>Step 2:</strong> Inserisci l'URL
                        </label>
