      ...
      <div className={Styles.tabPanels}>
        <If condition={this.props.activeTab === "local"}>
          ...
          <section className={Styles.tabPanel}>
            <label className={Styles.label}>
              <strong>Step 1:</strong> Seleziona il tipo di file (facoltativo)
            </label>
            <Dropdown
            ...
            />
            <label className={Styles.label}>
              <strong>Step 2:</strong> Seleziona il file
            </label>
            <FileInput
        ...
        <If condition={this.props.activeTab === "web"}>
          ...
          <section className={Styles.tabPanel}>
            ...
            />
            <label className={Styles.label}>
              <strong>Step 2:</strong> Inserisci l'URL del layer
            </label>
