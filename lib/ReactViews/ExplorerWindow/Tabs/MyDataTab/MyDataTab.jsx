...
const MyDataTab = createReactClass({
    ...
    renderTabs() {
      const tabs = [
          {
              id: 'local',
              caption: 'Aggiungi dati locali'
          },
          {
              id: 'web',
              caption: 'Aggiungi dati dal web'
          }
      ];
      return (
    ...
    renderPromptBox() {
        ...
        return (
            <div className={Styles.dataTypeTab}>
                <div>
                    <div>
                        Trascina un file qui per caricarlo nella mappa
                    </div>
                    <div>(non sarà salvato o caricato via internet)</div>
                    ...
                    <If condition={showTwoColumn}>
                        <div className={Styles.addedData}>
                            <p className={Styles.explanation}>
                                <strong>Note: </strong>I layer aggiunti in questo modo non
                                sono salvati o resi visibili ad altri.
                            </p>
