    ...
    getDefaultProps() {
        return {
            conversionList: [
                ...
                { desc: 'EPSG:4326 WGS84 → EPSG:4258 ETRS89', from: 4326, to: 4258, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:25832 ETRS89 / UTM zone 32N', from: 4326, to: 25832, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:25833 ETRS89 / UTM zone 33N', from: 4326, to: 25833, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:6706 RDN2008', from: 4326, to: 6706, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:7791 RDN2008 / UTM zone 32N', from: 4326, to: 7791, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:7792 RDN2008 / UTM zone 33N', from: 4326, to: 7792, wkt: {} },
                ...
                { desc: 'EPSG:4326 WGS84 → EPSG:32632 WGS 84 / UTM zone 32N', from: 4326, to: 32632, wkt: {} },
                { desc: 'EPSG:4326 WGS84 → EPSG:32633 WGS 84 / UTM zone 33N', from: 4326, to: 32633, wkt: {} },
                ...
                { desc: 'EPSG:4258 ETRS89 → EPSG:4326 WGS84', from: 4258, to: 4326, wkt: {} },
                { desc: 'EPSG:25832 ETRS89 / UTM zone 32N → EPSG:4326 WGS84', from: 25832, to: 4326, wkt: {} },
                { desc: 'EPSG:25833 ETRS89 / UTM zone 33N → EPSG:4326 WGS84', from: 25833, to: 4326, wkt: {} },
                { desc: 'EPSG:6706 RDN2008 → EPSG:4326 WGS84', from: 6706, to: 4326, wkt: {} },
                { desc: 'EPSG:7791 RDN2008 / UTM zone 32N → EPSG:4326 WGS84', from: 7791, to: 4326, wkt: {} },
                { desc: 'EPSG:7792 RDN2008 / UTM zone 33N → EPSG:4326 WGS84', from: 7792, to: 4326, wkt: {} },
                ...
                { desc: 'EPSG:32632 WGS 84 / UTM zone 32N → EPSG:4326 WGS84', from: 32632, to: 4326, wkt: {} },
                { desc: 'EPSG:32633 WGS 84 / UTM zone 33N → EPSG:4326 WGS84', from: 32633, to: 4326, wkt: {} }
            ]
        };
    },
