...
const MeasurablePanel = observer((props: Props) => {
      ...
      <div className={Styles.header}>
        <div className={classNames("drag-handle", Styles.btnPanelHeading)}>
          <span style={{ display: "flex", justifyContent: "center" }}>
            <b>{String(i18next.t("measurableGeometry.header"))}</b>
          </span>
          <button
            type="button"
    ...
    return (
      <>
        <Text textLight style={{ marginLeft: 1 }} title="">
          {String(i18next.t("measurableGeometry.samplingStepHeader"))}:
          <br />
        ...
        <Box styledMargin="5px">
            ...
            <Input
              css={`
                ...
                border-color: ${isValidSamplingPathStep
                  ...
                  : "red"};
              `}
              title={String(i18next.t("measurableGeometry.samplingStepHeader"))}
              light={false}
              dark
              type="number"
              min={1}
          ...
          >
            {String(i18next.t("measurableGeometry.samplingStepButtonText"))}
          </Button>
        </Box>
      </>
    );
        ...
        <Box>
          {!terria?.measurableGeom?.hasArea && (
            <Button
              ...
              `}
              onClick={toggleChart}
              title={String(i18next.t("measurableGeometry.showElevationChart"))}
            >
              <StyledIcon
                light
                realDark={false}
          ...
          <Button
            ...
            title={String(i18next.t("measurableGeometry.clampLineButtonTitle"))}
          >
            {terria.clampMeasureLineToGround
              ? String(i18next.t("measurableGeometry.clampLineToGround"))
              : String(i18next.t("measurableGeometry.dontClampLineToGround"))}
          </Button>
        </Box>
  ...
  const renderPathSummary = () => {
    return (
      <>
        <Text textLight style={{ marginLeft: 1 }} title="">
          {String(i18next.t("measurableGeometry.geometrySummaryHeader"))}
        </Text>
        <small>
  ...
  const renderStepDetails = () => {
    ...
    return (
      <>
        <Text textLight style={{ marginLeft: 1 }} title="">
          {String(i18next.t("measurableGeometry.geometrySummaryStopSummary"))}
        </Text>
        <small>
          <table className={Styles.elevation}>
            <thead>
