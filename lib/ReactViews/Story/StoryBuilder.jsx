...
const StoryBuilder = createReactClass({
  ...
  recaptureScene(story) {
    ...
    if (storyIndex >= 0) {
      ...
      throw new Error("La Storia non esiste");
    }
  },
  ...
  renderIntro() {
    return (
      <div className={Styles.intro}>
        ...
        <strong>Questo è il tuo editor di Storie</strong>
    ...
    return (
      <div className={className}>
        <BadgeBar label="Scenes" badge={this.props.terria.stories.length}>
          ...
          >
            Rimuovi tutto <Icon glyph={Icon.GLYPHS.remove} />
          </button>
        </BadgeBar>
        ...
        <div className={Styles.header}>
          ...
          <div className={Styles.actions}>
            ...
            <button
              ...
              title="Cattura la scena corrente"
              onClick={this.onClickCapture}
            >
              {" "}
              <Icon glyph={Icon.GLYPHS.story} /> Cattura la scena{" "}
            </button>
          </div>
        </div>
