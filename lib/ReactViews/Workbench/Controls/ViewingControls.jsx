      ...
      <ul className={Styles.control}>
        <If condition={item.canZoomTo}>
          <li className={classNames(Styles.zoom, classList)}>
            <button
              type="button"
              onClick={this.zoomTo}
              title="Zoom sull'intera estensione del layer"
        ...
        <If condition={item.showsInfo}>
          <li className={classNames(Styles.info, classList)}>
            <button
              ...
              className={Styles.btn}
              title="Mostra le informazioni riguardanti il layer"
            >
              Metadati
            </button>
          </li>
        ...
        <If condition={canSplit}>
          <li className={classNames(Styles.split, classList)}>
            <button
              ...
              title="Duplica la mappa e mostra lo splitter"
              className={Styles.btn}
            >
              Split
            </button>
        ...
        <If condition={defined(item.linkedWcsUrl)}>
          <li className={classNames(Styles.info, classList)}>
            <button
              ...
              className={Styles.btn}
              title="Esporta i dati della mappa"
            >
              Esporta
            </button>
          </li>
        ...
        <li className={classNames(Styles.remove, classList)}>
          <button
            ...
            title="Rimuove il layer"
            className={Styles.btn}
          >
            Rimuovi <Icon glyph={Icon.GLYPHS.remove} />
          </button>
        </li>
      </ul>
    );
