...
function initializeTerrainProvider(terriaViewer) {
    ...
    if (!terriaViewer.terria.configParameters.hideTerriaLogo) {
        ...
        terriaViewer._defaultTerriaCredit = new Credit('<a id="terriaLogo" href="https://terria.io/" target="_blank" rel="noopener noreferrer" ><img src="' + terriaLogo + '" title="Built with Terria"/></a>', true);
    } else {
