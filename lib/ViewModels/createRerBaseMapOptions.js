...
var createRerBaseMapOptions = function(terria) {
    ...
    dbtrCtr.url = 'http://servizigis.regione.emilia-romagna.it/arcgis/rest/services/cache/dbtr_ctrmultiscala_wgs84wm/MapServer';
    dbtrCtr.parameters = {
        tiled: true
    };
    dbtrCtr.opacity = 1.0;
    ...
    dbtrWeb.url = 'http://servizigis.regione.emilia-romagna.it/arcgis/rest/services/cache/dbtr_wgs84wm/MapServer';
    dbtrWeb.parameters = {
        tiled: true
    };
    dbtrWeb.opacity = 1.0;
    ...
    ctr250k.url = 'http://servizigis.regione.emilia-romagna.it/wms/ctr250c_ed2016';
    ...
    */
    ...
    ortoimmagini2011.url = 'http://servizigis.regione.emilia-romagna.it/arcgis/rest/services/cache/agea2011_wgs84wm/MapServer';
    ...
    cartaStorica1853.url = 'http://servizigis.regione.emilia-romagna.it/wms/carta_storica_regionale_1853';
    ...
    ortoimmagini1954.url = 'http://servizigis.regione.emilia-romagna.it/wms/VoloGAI1954';
