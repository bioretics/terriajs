  ...
  switch (spec.type) {
    ...
    case "scatter": {
      ...
      return {
        ...
        result:
          xField && yField
            ? (computeScatter(rows, xField, yField) ?? undefined)
            : undefined
      };
    }
    case "bar": {
      ...
      return {
        ...
        result: category
          ? (computeBar(
              ...
              category,
              aggregation,
              aggregation === "count" ? null : (spec.valueField ?? null)
            ) ?? undefined)
          : undefined
      };
    }
    case "line": {
      ...
      return {
        type: "line",
        field,
        result: field ? (computeLine(rows, field) ?? undefined) : undefined
      };
    }
    case "box": {
      const field = spec.field ?? "";
      return {
        ...
        field,
        result: field
          ? (computeBox(numericValues(rows, field)) ?? undefined)
          : undefined
      };
    }
    case "pie": {
