...
// Fork (rer3d): zoomIdentity used to reset the zoom transform on mount.
...
export const ZoomX = ({
  ...
  useEffect(() => {
    ...
    // Fork (rer3d): reset the transform so a re-mounted chart (e.g. a new
    // measured path) starts unzoomed.
