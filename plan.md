...
Turborepo monorepo** (`packages/terriajs` + `apps/terriamap`). The fork *also* just did its own
...
### Batch 0 — Workspace bootstrap  *(blocker; class c)*
...
### Batch 1 — Images & SVG  *(Phase 1; class a)*
...
### Batch 2 — Mechanical relocation bulk  *(~379; class a)*
...
### Batch 3 — Type-change & rename collisions  *(Branch C/D, ~60; class b/c)*
...
### Batch 4 — JS/TS semantic 3-way  *(Branch B, ~50; class c/d — the real work)*
...
### Batch 6 — Other (SCSS/docs) + regenerate `.scss.d.ts`  *(class b)*
...
### Batch 7 — Deletion sweep & silent audit  *(Phase 3; class a/c)*
